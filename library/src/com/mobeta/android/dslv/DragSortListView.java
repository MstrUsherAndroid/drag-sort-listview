...
public class DragSortListView extends ListView {
    ...
    public DragSortListView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            if (useDefault) {
                ...
                dragSortController = new DragSortController(
                ...
                dragSortController.setBackgroundColor(bgColor);
    ...
    public void setDragSortControllerLongPressCallback(DragSortController.onLongPressCallback onLongPressCallback) {
        if (dragSortController != null) {
            dragSortController.setLongPressCallback(onLongPressCallback);
        }
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (mFloatView != null) {
            ...
            // xiaoyu 2015-08-21, set the view to its original x position.
            canvas.translate(getPaddingLeft(), mFloatLoc.y);
